...
$$\sum{i=1}{n} i=\frac{n\left(n+1\right)}{2} \forall n\geq 1$$
...
$$\sum{i=1}{1} i=1=\frac{1\left(1+1\right)}{2}$$
...
Mas lembra-te que estamos a assumir a proposição para $n$! Logo, supomos que $\sum{i=1}{n} i=\frac{n\left(n+1\right)}{2}$.

Substituindo isso na expressão anterior,

$$n+1 + \sum{i=1}{n} i=n+1 + \left(\frac{n\left(n+1\right)}{2}\right)$$
